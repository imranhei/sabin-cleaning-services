...
const Home = () => {
  return (
    <div>
      ...
      <div className="lg:flex space-y-10 lg:space-x-10 items-center max-w-7xl mx-auto px-4 py-10">
        <div className="relative flex-1">
          <div className="flex justify-between gap-6 pb-[calc(40%)] w-full">
            ...
            <div className="p-4 h-fit rounded-xl bg-[#79c043] flex flex-col justify-center gap-2">
              <h1 className="text-white sm:text-5xl text-3xl font-bold text-center">5.0</h1>
              <div className="flex items-center gap-1">
                {Array.from({ length: 5 }, (_, index) => (
                  <Star color="#ffde05" fill="#ffde05" strokeWidth={0.5} className="size-4 sm:size-6" />
                ))}
              </div>
          ...
          <div className="grid grid-cols-3 gap-4 mt-6">
            {Array.from({ length: 6 }, (_, index) => (
              <div className="group p-4 bg-gray-100 hover:bg-[#79c043] duration-200 w-full aspect-square rounded-md flex flex-col items-center justify-center gap-4">
                <BrushCleaning className="sm:size-12 size-8 group-hover:text-white text-[#79c043] duration-200" />
                <h1 className="uppercase sm:text-base text-sm text-center font-semibold text-muted-foreground group-hover:text-white duration-200">End of Lease Cleaning</h1>
            </div>
            ))}
          </div>
        </div>
