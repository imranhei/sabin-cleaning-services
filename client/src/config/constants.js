...
export const footerLinks = [
  ...
  //     { title: "Maids? NO WAY!", url: "#" },
  //     { title: "The Rwanda Project", url: "#" },
  //     { title: "Blog", url: "/blog" },
  ...
  //   items: [
  //     { title: "Find a Location Near you", url: "#" },
  ...
  // },
  {
    title: "Our Services",
    items: [
      { title: "End of Lease Cleaning", url: "#" },
      { title: "Bond Back Cleaning", url: "#" },
      { title: "Moving In And Out Cleaning", url: "#" },
      { title: "Carpet Cleaning", url: "#" },
      { title: "Deep Cleaning", url: "#" },
      { title: "Commercial Cleaning", url: "#" },
      { title: "Tile and Grout Cleaning", url: "#" },
      ...
      { title: "Driveway Wash", url: "#" },
      { title: "Window Cleaning", url: "#" },
      { title: "Building & Brick Wall Cleaning", url: "#" },
    ],
  },
];
